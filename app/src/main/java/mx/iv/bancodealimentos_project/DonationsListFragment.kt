...
class DonationsListFragment : Fragment() {
    ...
    private fun getDonationsList() {
        donationsList.add(DonationData(1, 123F, "07/02/200"))
        donationsList.add(DonationData(2, 70F, "08/02/200"))
        donationsList.add(DonationData(3, 60F, "09/02/200"))
        donationsList.add(DonationData(4, 60F, "10/02/200"))
    }
